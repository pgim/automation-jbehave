...
public class Stories extends JUnitStories {
	...
	private static final String SPRING_CONTEXT = "page-steps.xml";
    ...
    public InjectableStepsFactory stepsFactory() {
        ApplicationContext context = new SpringApplicationContextFactory(SPRING_CONTEXT).createApplicationContext();
